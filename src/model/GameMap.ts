...
export class USMap {
  ...
  private populateCities() {
    this.cities.push(new USCity(USCities.Atlanta, 1064, 615, 156, 109, 'Atlanta', -33, -11, 'right'));
    this.cities.push(new USCity(USCities.Billings, 432, 215, 79, 62, 'Billings', -31, 13, 'right')); // substituted for Helena
    this.cities.push(new USCity(USCities.Boston, 1353, 255, 188, 66, 'Boston', 5, -15, 'left'));
    ...
    this.cities.push(new USCity(USCities.KansasCity, 760, 465, 117, 91, 'Kansas\nCity', 7, 31, 'left'));
    this.cities.push(new USCity(USCities.LasVegas, 213, 524, 52, 97, 'Las Vegas', -5, 21, 'left'));
    this.cities.push(new USCity(USCities.LittleRock, 843, 608, 128, 109, 'Little\nRock', 12, 15, 'left'));
    this.cities.push(new USCity(USCities.LosAngeles, 105, 573, 36, 102, 'Los\nAngeles', 5, 20, 'right'));
    this.cities.push(new USCity(USCities.Miami, 1238, 862, 176, 137, 'Miami', 15, 0, 'left'));
    this.cities.push(new USCity(USCities.Minneapolis, 799, 266, 122, 68, 'Minneapolis', -37, 15, 'right')); // substituted for Duluth
    this.cities.push(new USCity(USCities.Montreal, 1264, 158, 176, 55, 'Montreal', -10, -20, 'left'));
    this.cities.push(new USCity(USCities.Nashville, 985, 545, 145, 102, 'Nashville', 15, 0, 'left'));
    this.cities.push(new USCity(USCities.NewOrleans, 932, 766, 138, 127, 'New\nOrleans', 10, 22, 'right'));
    this.cities.push(new USCity(USCities.NewYork, 1304, 316, 182, 73, 'New York', 12, 17, 'left'));
    this.cities.push(new USCity(USCities.OklahomaCity, 697, 588, 110, 106, 'Oklahoma\nCity', 40, -31, 'left'));
    this.cities.push(new USCity(USCities.Omaha, 724, 389, 113, 82, 'Omaha', -11, 24, 'right'));
    this.cities.push(new USCity(USCities.Phoenix, 286, 614, 60, 109, 'Phoenix', 5, 21, 'right'));
    this.cities.push(new USCity(USCities.Pittsburgh, 1148, 364, 165, 80, 'Pittsburgh', -8, -41, 'right'));
    this.cities.push(new USCity(USCities.Portland, 84, 188, 37, 57, 'Portland', 26, -3, 'left'));
    this.cities.push(new USCity(USCities.Raleigh, 1208, 516, 174, 98, 'Raleigh', 15, 0, 'left'));
    this.cities.push(new USCity(USCities.SaintLouis, 877, 472, 131, 93, 'Saint\nLouis', -12, -47, 'right'));
    this.cities.push(new USCity(USCities.SaltLakeCity, 318, 381, 63, 82, 'Salt Lake City', -45, -20, 'right'));
    this.cities.push(new USCity(USCities.SanFrancisco, 27, 430, 30, 88, 'San Francisco', 30, 27, 'left'));
    this.cities.push(new USCity(USCities.SantaFe, 458, 564, 81, 104, 'Santa Fe', 9, 26, 'left'));
    this.cities.push(new USCity(USCities.SaultSteMarie, 1005, 175, 148, 59, 'Sault Ste.\nMarie', 0, -44, 'center'));
    this.cities.push(new USCity(USCities.Seattle, 116, 106, 41, 49, 'Seattle', -15, 0, 'right'));
    this.cities.push(new USCity(USCities.Toronto, 1154, 255, 165, 66, 'Toronto', 12, 17, 'left'));
    this.cities.push(new USCity(USCities.Vancouver, 120, 45, 41, 41, 'Vancouver', 5, -21, 'right'));
    this.cities.push(new USCity(USCities.Washington, 1229, 402, 175, 84, 'Washington', 16, 22, 'left'));
    this.cities.push(new USCity(USCities.Winnipeg, 698, 91, 109, 47, 'Winnipeg', -10, -20, 'left'));
  }

  private populateRoutes() {
    let id = 0;
    let route = new Route(id++, USCities.Vancouver, USCities.Calgary, RouteColor.Grey, 53);
    ...
    route = new Route(id++, USCities.Calgary, USCities.Winnipeg, RouteColor.White, 50);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Winnipeg, USCities.SaultSteMarie, RouteColor.Grey, 40);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.SaultSteMarie, USCities.Montreal, RouteColor.Black, 39);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Montreal, USCities.Boston, RouteColor.Grey, 42);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Vancouver, USCities.Seattle, RouteColor.Grey, 30);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Seattle, USCities.Calgary, RouteColor.Grey, 46);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Seattle, USCities.Billings, RouteColor.Yellow, 44);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Calgary, USCities.Billings, RouteColor.Grey, 40);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Billings, USCities.Winnipeg, RouteColor.Blue, 58);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Billings, USCities.Minneapolis, RouteColor.Orange, 49);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Winnipeg, USCities.Minneapolis, RouteColor.Black, 37);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Minneapolis, USCities.Toronto, RouteColor.Pink, 46);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Minneapolis, USCities.SaultSteMarie, RouteColor.Grey, 55);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.SaultSteMarie, USCities.Toronto, RouteColor.Grey, 55);
    this.routes.push(route);
    route.segments.push(new RouteSegment(1050, 202, 20));
    route.segments.push(new RouteSegment(1106, 224, 23));

    route = new Route(id++, USCities.Seattle, USCities.Portland, RouteColor.Grey, 40);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Portland, USCities.SanFrancisco, RouteColor.Green, 40);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Portland, USCities.SanFrancisco, RouteColor.Pink, 38);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Portland, USCities.SaltLakeCity, RouteColor.Blue, 40);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.SanFrancisco, USCities.SaltLakeCity, RouteColor.Orange, 43);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.SanFrancisco, USCities.SaltLakeCity, RouteColor.White, 43);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.SaltLakeCity, USCities.Billings, RouteColor.Pink, 48);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.SanFrancisco, USCities.LosAngeles, RouteColor.Yellow, 40);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.SanFrancisco, USCities.LosAngeles, RouteColor.Pink, 36);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.LosAngeles, USCities.LasVegas, RouteColor.Grey, 37);
    this.routes.push(route);
    route.segments.push(new RouteSegment(135, 544, -40));
    route.segments.push(new RouteSegment(174, 527, -8));

    route = new Route(id++, USCities.LasVegas, USCities.SaltLakeCity, RouteColor.Orange, 40);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Billings, USCities.Denver, RouteColor.Green, 44);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.SaltLakeCity, USCities.Denver, RouteColor.Red, 43);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.SaltLakeCity, USCities.Denver, RouteColor.Yellow, 43);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.LosAngeles, USCities.ElPaso, RouteColor.Black, 53);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.LosAngeles, USCities.Phoenix, RouteColor.Grey, 44);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Phoenix, USCities.Denver, RouteColor.White, 42);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Phoenix, USCities.SantaFe, RouteColor.Grey, 43);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Phoenix, USCities.ElPaso, RouteColor.Grey, 44);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.ElPaso, USCities.SantaFe, RouteColor.Grey, 46);
    this.routes.push(route);
    route.segments.push(new RouteSegment(453, 661, -88));
    route.segments.push(new RouteSegment(455, 610, -88));

    route = new Route(id++, USCities.SantaFe, USCities.Denver, RouteColor.Grey, 43);
    this.routes.push(route);
    route.segments.push(new RouteSegment(478, 530, -60));
    route.segments.push(new RouteSegment(494, 486, -80));

    route = new Route(id++, USCities.Denver, USCities.Omaha, RouteColor.Pink, 45);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Billings, USCities.Omaha, RouteColor.Red, 56);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Omaha, USCities.Minneapolis, RouteColor.Grey, 45);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Minneapolis, USCities.Chicago, RouteColor.Red, 36);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Omaha, USCities.KansasCity, RouteColor.Grey, 42);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Omaha, USCities.Chicago, RouteColor.Blue, 39);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Chicago, USCities.Toronto, RouteColor.White, 50);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Toronto, USCities.Montreal, RouteColor.Grey, 32);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Chicago, USCities.Pittsburgh, RouteColor.Black, 47);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Raleigh, USCities.Washington, RouteColor.Grey, 34);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Pittsburgh, USCities.Raleigh, RouteColor.Grey, 56);
    this.routes.push(route);
    route.segments.push(new RouteSegment(1150, 422, 90));
    route.segments.push(new RouteSegment(1170, 480, 52));

    route = new Route(id++, USCities.Nashville, USCities.Pittsburgh, RouteColor.Yellow, 43);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.SaintLouis, USCities.Pittsburgh, RouteColor.Green, 43);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.SaintLouis, USCities.Chicago, RouteColor.Green, 40);
    this.routes.push(route);
    route.segments.push(new RouteSegment(884, 427, -62));
    route.segments.push(new RouteSegment(905, 388, -62));

    route = new Route(id++, USCities.SaintLouis, USCities.Chicago, RouteColor.White, 40);
    this.routes.push(route);
    route.segments.push(new RouteSegment(902, 437, -62));
    route.segments.push(new RouteSegment(923, 398, -62));

    route = new Route(id++, USCities.OklahomaCity, USCities.KansasCity, RouteColor.Grey, 43);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.KansasCity, USCities.SaintLouis, RouteColor.Blue, 35);
    this.routes.push(route);
    route.segments.push(new RouteSegment(800, 457, 5));
    route.segments.push(new RouteSegment(840, 460, 5));

    route = new Route(id++, USCities.KansasCity, USCities.SaintLouis, RouteColor.Pink, 35);
    this.routes.push(route);
    route.segments.push(new RouteSegment(799, 477, 5));
    route.segments.push(new RouteSegment(839, 480, 5));

    route = new Route(id++, USCities.Denver, USCities.OklahomaCity, RouteColor.Red, 47);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Denver, USCities.KansasCity, RouteColor.Black, 45);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.OklahomaCity, USCities.Dallas, RouteColor.Grey, 25);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Dallas, USCities.Houston, RouteColor.Grey, 56);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.SantaFe, USCities.OklahomaCity, RouteColor.Blue, 60);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.ElPaso, USCities.OklahomaCity, RouteColor.Yellow, 40);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.ElPaso, USCities.Dallas, RouteColor.Red, 53);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.ElPaso, USCities.Houston, RouteColor.Green, 41);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.OklahomaCity, USCities.LittleRock, RouteColor.Grey, 47);
    this.routes.push(route);
    route.segments.push(new RouteSegment(744, 594, 9));
    route.segments.push(new RouteSegment(795, 602, 9));

    route = new Route(id++, USCities.Dallas, USCities.LittleRock, RouteColor.Grey, 46);
    this.routes.push(route);
    route.segments.push(new RouteSegment(758, 662, -31));
    route.segments.push(new RouteSegment(802, 636, -31));

    route = new Route(id++, USCities.SaintLouis, USCities.Nashville, RouteColor.Grey, 40);
    this.routes.push(route);
    route.segments.push(new RouteSegment(911, 499, 34));
    route.segments.push(new RouteSegment(949, 524, 34));

    route = new Route(id++, USCities.LittleRock, USCities.SaintLouis, RouteColor.Grey, 46);
    this.routes.push(route);
    route.segments.push(new RouteSegment(854, 565, -75));
    route.segments.push(new RouteSegment(867, 516, -75));

    route = new Route(id++, USCities.LittleRock, USCities.Nashville, RouteColor.White, 34);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Houston, USCities.NewOrleans, RouteColor.Grey, 57);
    this.routes.push(route);
    route.segments.push(new RouteSegment(813, 768, -1));
    route.segments.push(new RouteSegment(875, 767, -1));

    route = new Route(id++, USCities.LittleRock, USCities.NewOrleans, RouteColor.Green, 43);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Nashville, USCities.Atlanta, RouteColor.Grey, 58);
    this.routes.push(route);
    route.segments.push(new RouteSegment(1023, 581, 42));

    route = new Route(id++, USCities.Atlanta, USCities.Raleigh, RouteColor.Grey, 58);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Raleigh, USCities.Charleston, RouteColor.Grey, 30);
    this.routes.push(route);
    route.segments.push(new RouteSegment(1225, 545, 60));
    route.segments.push(new RouteSegment(1225, 581, 120));

    route = new Route(id++, USCities.NewOrleans, USCities.Atlanta, RouteColor.Yellow, 42);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.NewOrleans, USCities.Atlanta, RouteColor.Orange, 35);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Atlanta, USCities.Miami, RouteColor.Blue, 47);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Charleston, USCities.Miami, RouteColor.Pink, 52);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.NewOrleans, USCities.Miami, RouteColor.Red, 46);
    this.routes.push(route);
    ...
    route = new Route(id++, USCities.Atlanta, USCities.Charleston, RouteColor.Grey, 48);
    this.routes.push(route);
