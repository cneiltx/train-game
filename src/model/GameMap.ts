...
export class GameMap {
  ...
  private populateRoutes() {
    ...
    route = new Route(USCities.Calgary, USCities.Winnipeg, RouteColor.White, 50);
    this.routes.push(route);
    ...
    route = new Route(USCities.Winnipeg, USCities.SaultSteMarie, RouteColor.Grey, 40);
    this.routes.push(route);
    ...
    route = new Route(USCities.SaultSteMarie, USCities.Montreal, RouteColor.Black, 39);
    this.routes.push(route);
    ...
    route = new Route(USCities.Montreal, USCities.Boston, RouteColor.Grey, 42);
    this.routes.push(route);
    ...
    route = new Route(USCities.Vancouver, USCities.Seattle, RouteColor.Grey, 30);
    this.routes.push(route);
    ...
    route = new Route(USCities.Seattle, USCities.Calgary, RouteColor.Grey, 46);
    this.routes.push(route);
    ...
    route = new Route(USCities.Seattle, USCities.Billings, RouteColor.Yellow, 44);
    this.routes.push(route);
    ...
    route = new Route(USCities.Calgary, USCities.Billings, RouteColor.Grey, 40);
    this.routes.push(route);
    ...
    route = new Route(USCities.Billings, USCities.Winnipeg, RouteColor.Blue, 58);
    this.routes.push(route);
    ...
    route = new Route(USCities.Billings, USCities.Minneapolis, RouteColor.Orange, 49);
    this.routes.push(route);
    ...
    route = new Route(USCities.Winnipeg, USCities.Minneapolis, RouteColor.Black, 37);
    this.routes.push(route);
    ...
    route = new Route(USCities.Minneapolis, USCities.Toronto, RouteColor.Pink, 46);
    this.routes.push(route);
    ...
    route = new Route(USCities.Minneapolis, USCities.SaultSteMarie, RouteColor.Grey, 55);
    this.routes.push(route);
    ...
    route = new Route(USCities.SaultSteMarie, USCities.Toronto, RouteColor.Grey, 55);
    this.routes.push(route);
    route.segments.push(new RouteSegment(1050, 202, 20));
    route.segments.push(new RouteSegment(1106, 224, 23));

    route = new Route(USCities.Seattle, USCities.Portland, RouteColor.Grey, 40);
    this.routes.push(route);
    ...
    route = new Route(USCities.Portland, USCities.SanFrancisco, RouteColor.Green, 40);
    this.routes.push(route);
    ...
    route = new Route(USCities.Portland, USCities.SanFrancisco, RouteColor.Pink, 38);
    this.routes.push(route);
    ...
    route = new Route(USCities.Portland, USCities.SaltLakeCity, RouteColor.Blue, 40);
    this.routes.push(route);
    ...
    route = new Route(USCities.SanFrancisco, USCities.SaltLakeCity, RouteColor.Orange, 43);
    this.routes.push(route);
    ...
    route = new Route(USCities.SanFrancisco, USCities.SaltLakeCity, RouteColor.White, 43);
    this.routes.push(route);
    ...
    route = new Route(USCities.SaltLakeCity, USCities.Billings, RouteColor.Pink, 48);
    this.routes.push(route);
    ...
    route = new Route(USCities.SanFrancisco, USCities.LosAngeles, RouteColor.Yellow, 40);
    this.routes.push(route);
    ...
    route = new Route(USCities.SanFrancisco, USCities.LosAngeles, RouteColor.Pink, 36);
    this.routes.push(route);
    ...
    route = new Route(USCities.LosAngeles, USCities.LasVegas, RouteColor.Grey, 37);
    this.routes.push(route);
    route.segments.push(new RouteSegment(135, 544, -40));
    route.segments.push(new RouteSegment(174, 527, -8));

    route = new Route(USCities.LasVegas, USCities.SaltLakeCity, RouteColor.Orange, 40);
    this.routes.push(route);
    ...
    route = new Route(USCities.Billings, USCities.Denver, RouteColor.Green, 44);
    this.routes.push(route);
    ...
    route = new Route(USCities.SaltLakeCity, USCities.Denver, RouteColor.Red, 43);
    this.routes.push(route);
    ...
    route = new Route(USCities.SaltLakeCity, USCities.Denver, RouteColor.Yellow, 43);
    this.routes.push(route);
    ...
    route = new Route(USCities.LosAngeles, USCities.ElPaso, RouteColor.Black, 53);
    this.routes.push(route);
    ...
    route = new Route(USCities.LosAngeles, USCities.Phoenix, RouteColor.Grey, 44);
    this.routes.push(route);
    ...
    route = new Route(USCities.Phoenix, USCities.Denver, RouteColor.White, 42);
    this.routes.push(route);
    ...
    route = new Route(USCities.Phoenix, USCities.SantaFe, RouteColor.Grey, 43);
    this.routes.push(route);
    ...
    route = new Route(USCities.Phoenix, USCities.ElPaso, RouteColor.Grey, 44);
    this.routes.push(route);
    ...
    route = new Route(USCities.ElPaso, USCities.SantaFe, RouteColor.Grey, 46);
    this.routes.push(route);
    route.segments.push(new RouteSegment(453, 661, -88));
    route.segments.push(new RouteSegment(455, 610, -88));

    route = new Route(USCities.SantaFe, USCities.Denver, RouteColor.Grey, 43);
    this.routes.push(route);
    route.segments.push(new RouteSegment(478, 530, -60));
    route.segments.push(new RouteSegment(494, 486, -80));

    route = new Route(USCities.Denver, USCities.Omaha, RouteColor.Pink, 45);
    this.routes.push(route);
    ...
    route = new Route(USCities.Billings, USCities.Omaha, RouteColor.Red, 56);
    this.routes.push(route);
    ...
    route = new Route(USCities.Omaha, USCities.Minneapolis, RouteColor.Grey, 45);
    this.routes.push(route);
    ...
    route = new Route(USCities.Minneapolis, USCities.Chicago, RouteColor.Red, 36);
    this.routes.push(route);
    ...
    route = new Route(USCities.Omaha, USCities.KansasCity, RouteColor.Grey, 42);
    this.routes.push(route);
    ...
    route = new Route(USCities.Omaha, USCities.Chicago, RouteColor.Blue, 39);
    this.routes.push(route);
    ...
    route = new Route(USCities.Chicago, USCities.Toronto, RouteColor.White, 50);
    this.routes.push(route);
    ...
    route = new Route(USCities.Toronto, USCities.Montreal, RouteColor.Grey, 32);
    this.routes.push(route);
    ...
    route = new Route(USCities.Chicago, USCities.Pittsburgh, RouteColor.Black, 47);
    this.routes.push(route);
    ...
    route = new Route(USCities.Raleigh, USCities.Washington, RouteColor.Grey, 34);
    this.routes.push(route);
    ...
    route = new Route(USCities.Pittsburgh, USCities.Raleigh, RouteColor.Grey, 56);
    this.routes.push(route);
    route.segments.push(new RouteSegment(1150, 422, 90));
    route.segments.push(new RouteSegment(1170, 480, 52));

    route = new Route(USCities.Nashville, USCities.Pittsburgh, RouteColor.Yellow, 43);
    this.routes.push(route);
    ...
    route = new Route(USCities.SaintLouis, USCities.Pittsburgh, RouteColor.Green, 43);
    this.routes.push(route);
    ...
    route = new Route(USCities.SaintLouis, USCities.Chicago, RouteColor.Green, 40);
    this.routes.push(route);
    route.segments.push(new RouteSegment(884, 427, -62));
    route.segments.push(new RouteSegment(905, 388, -62));

    route = new Route(USCities.SaintLouis, USCities.Chicago, RouteColor.White, 40);
    this.routes.push(route);
    route.segments.push(new RouteSegment(902, 437, -62));
    route.segments.push(new RouteSegment(923, 398, -62));

    route = new Route(USCities.OklahomaCity, USCities.KansasCity, RouteColor.Grey, 43);
    this.routes.push(route);
    ...
    route = new Route(USCities.KansasCity, USCities.SaintLouis, RouteColor.Blue, 35);
    this.routes.push(route);
    route.segments.push(new RouteSegment(800, 457, 5));
    route.segments.push(new RouteSegment(840, 460, 5));

    route = new Route(USCities.KansasCity, USCities.SaintLouis, RouteColor.Pink, 35);
    this.routes.push(route);
    route.segments.push(new RouteSegment(799, 477, 5));
    route.segments.push(new RouteSegment(839, 480, 5));

    route = new Route(USCities.Denver, USCities.OklahomaCity, RouteColor.Red, 47);
    this.routes.push(route);
    ...
    route = new Route(USCities.Denver, USCities.KansasCity, RouteColor.Black, 45);
    this.routes.push(route);
    ...
    route = new Route(USCities.OklahomaCity, USCities.Dallas, RouteColor.Grey, 25);
    this.routes.push(route);
    ...
    route = new Route(USCities.Dallas, USCities.Houston, RouteColor.Grey, 56);
    this.routes.push(route);
    ...
    route = new Route(USCities.SantaFe, USCities.OklahomaCity, RouteColor.Blue, 60);
    this.routes.push(route);
    ...
    route = new Route(USCities.ElPaso, USCities.OklahomaCity, RouteColor.Yellow, 40);
    this.routes.push(route);
    ...
    route = new Route(USCities.ElPaso, USCities.Dallas, RouteColor.Red, 53);
    this.routes.push(route);
    ...
    route = new Route(USCities.ElPaso, USCities.Houston, RouteColor.Green, 41);
    this.routes.push(route);
    ...
    route = new Route(USCities.Houston, USCities.NewOrleans, RouteColor.Grey, 57);
    this.routes.push(route);
    route.segments.push(new RouteSegment(813, 768, -1));
    route.segments.push(new RouteSegment(875, 767, -1));

    route = new Route(USCities.LittleRock, USCities.NewOrleans, RouteColor.Green, 43);
    this.routes.push(route);
    ...
    route = new Route(USCities.Nashville, USCities.Atlanta, RouteColor.Grey, 58);
    this.routes.push(route);
    route.segments.push(new RouteSegment(1023, 581, 42));

    route = new Route(USCities.Atlanta, USCities.Raleigh, RouteColor.Grey, 58);
    this.routes.push(route);
    ...
    route = new Route(USCities.Raleigh, USCities.Charleston, RouteColor.Grey, 30);
    this.routes.push(route);
    route.segments.push(new RouteSegment(1225, 545, 60));
    route.segments.push(new RouteSegment(1225, 581, 120));

    route = new Route(USCities.NewOrleans, USCities.Atlanta, RouteColor.Yellow, 42);
    this.routes.push(route);
    ...
    route = new Route(USCities.NewOrleans, USCities.Atlanta, RouteColor.Orange, 35);
    this.routes.push(route);
    ...
    route = new Route(USCities.Atlanta, USCities.Miami, RouteColor.Blue, 47);
    this.routes.push(route);
    ...
    route = new Route(USCities.Charleston, USCities.Miami, RouteColor.Pink, 52);
    this.routes.push(route);
    ...
    route = new Route(USCities.NewOrleans, USCities.Miami, RouteColor.Red, 46);
    this.routes.push(route);
    ...
    route = new Route(USCities.Atlanta, USCities.Charleston, RouteColor.Grey, 48);
    this.routes.push(route);
